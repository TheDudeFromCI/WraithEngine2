...
import run.wraith.engine.opengl.renders.CameraListener;
 ...
 */
public class BackgroundImageModelInstance extends ModelInstance implements RenderIndex, CameraListener{
	private double renderIndex;
	public BackgroundImageModelInstance(Model model, Camera camera){
		super(model);
	...
	@Override
	public void cameraMoved(float x, float y, float z){
		getPosition().identity();
		getPosition().translate(x, y, z);
	}
}
